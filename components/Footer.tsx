...
// components/Footer.tsx - Add a border-top to separate from contact form
'use client';
  ...
  return (
    <footer className="bg-gray-900 text-gray-300 border-t border-gray-800">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4 leading-relaxed">
              Trusted roofing experts providing quality craftsmanship and reliable service for residential and commercial properties since 2014.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors text-sm">
                f
              </a>
              <a href="#" className="w-9 h-9 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors text-sm">
                t
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <span className="text-blue-400 text-lg">📍</span>
                <span className="text-gray-400">
                  123 Roofing Avenue, Suite 100<br />
                  Springfield, IL 62701
                </span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-blue-400 text-lg">📞</span>
                <a href="tel:+15551234567" className="text-gray-400 hover:text-blue-400">
                  (555) 123-4567
                </a>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-blue-400 text-lg">✉️</span>
                <a href="mailto:info@roofproexperts.com" className="text-gray-400 hover:text-blue-400">
                  info@roofproexperts.com
                </a>
              </div>
            </div>
      ...
      <div className="bg-blue-600 py-3">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          <p className="text-white text-sm md:text-base">
            🚨 <strong>24/7 Emergency Roofing Services Available</strong> — Call us anytime at{' '}
            <a href="tel:+15551234567" className="font-bold underline">
              (555) 123-4567
            </a>
          </p>
